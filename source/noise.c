...
void Draw_Noise(Terrain Floor) {
	...
	case T_Dirt:
		...
		break;
	case T_Soil:
		Min = (SDL_Color){ 70, 46, 34, SDL_ALPHA_OPAQUE };
		Max = (SDL_Color){ 84, 63, 47, SDL_ALPHA_OPAQUE };
		break;
	case T_Sand:
		Min = (SDL_Color){ 195, 184, 124, SDL_ALPHA_OPAQUE };
		Max = (SDL_Color){ 229, 216, 144, SDL_ALPHA_OPAQUE };
		break;
	case T_Gravel:
		Min = (SDL_Color){ 75, 71, 68, SDL_ALPHA_OPAQUE };
		Max = (SDL_Color){ 85, 85, 85, SDL_ALPHA_OPAQUE };
		break;
	case T_Rock:
		Min = (SDL_Color){ 172, 166, 158, SDL_ALPHA_OPAQUE };
		Max = (SDL_Color){ 199, 195, 191, SDL_ALPHA_OPAQUE };
		break;
	case T_Grass:
		Min = (SDL_Color){ 19, 109, 21, SDL_ALPHA_OPAQUE };
		Max = (SDL_Color){ 65, 152, 10, SDL_ALPHA_OPAQUE };
		break;
	default:
		break;
	}
